...
async def test_add_code_zwave_js(hass, client, lock_kwikset_910, integration):
    ...
    await hass.services.async_call(DOMAIN, SERVICE_ADD_CODE, servicedata, blocking=True)
    await hass.async_block_till_done()
...
async def test_clear_code_zwave_js(hass, client, lock_kwikset_910, integration):
    ...
    await hass.services.async_call(DOMAIN, SERVICE_CLEAR_CODE, servicedata, blocking=True)
    await hass.async_block_till_done()
