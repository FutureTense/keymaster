...
from custom_components.keymaster.config_flow import (
    ...
    _get_entities,  # noqa: PLC2701
    _get_schema,  # noqa: PLC2701
)
        ...
        (
            {
                ...
                "start_from": 1,
                "parent": "(none)",
                "notify_script": "script.keymaster_frontdoor_manual_notify",
            },
            "frontdoor",
            {
                "alarm_level_or_user_code_entity_id": "sensor.kwikset_touchpad_electronic_deadbolt_alarm_level_frontdoor",
...
async def test_options_flow(test_user_input, title, final_config_flow_data, hass, mock_get_entities):
...
async def test_options_flow_with_zwavejs(
    test_user_input, title, final_config_flow_data, hass, mock_get_entities, client, lock_kwikset_910, integration
):
    """Test config flow options."""
